...
insert  into `request`(`request_id`,`user_id`,`request_date`,`request_sold`,`request_price`,`request_book_name`,`request_book_author`,`request_book_year`,`request_book_publisher`) values 
(1,1,'2017-12-13',1,56,'yu','666',123,'tu'),
(2,NULL,'2017-12-12',0,2700,'ironman','saya',2009,'bca'),
(3,NULL,'2017-12-12',0,2700,'ironman','saya',2009,'bca'),
(4,3,'2017-12-12',0,300000,'tole','joshua',2010,'ivan');
...
(1,1,'2017-12-13',0,45000,'aku','dia',1998,'mereka','ini buku bekas gan hehe'),
...
(4,3,'2017-12-12',0,28900,'ironman','woi',2010,'akoe','test 3');
